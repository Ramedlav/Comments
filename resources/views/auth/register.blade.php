            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="burn_date" class="col-md-4 col-form-label text-md-right">{{ __('Birth Date') }}</label>

                            <div class="col-md-6">
                                <input id="burn_date" type="date" class="form-control " name="burn_date" value="{{ old('burn_date') }}" required autocomplete="burn_date">
                            </div>
                        </div>
